...
@section('content')
    <div class="container mt-5">
        <div class="border p-4" style="margin-top: 20vh">
            ...
            <h2 class="text-center mb-4">Edit Starbucks Payment</h2>

            <div class="d-flex justify-content-center align-items-center">
                <form action="/payments/update/{{ $payments->id }}" method="post" style="max-width: 400px; width: 100%;">
                    @csrf

                    <div class="mb-3">
                        <label for="name" class="form-label">Payment</label>
                        <input type="text" class="form-control" id="name" name="name"
                            value="{{ old('name', $payments->name) }}" required>
                    </div>
